...
const Common = ({student,handleChange,handleSubmit,text}) => {
  return (
    <div>
        ...
        <input type="number" name='class' placeholder='Class' value={student.class} onChange={(e)=>handleChange?handleChange(e):""} />
        <input type="text" name='division' placeholder='Division' value={student.division} onChange={(e)=>handleChange?handleChange(e):""} />
        <input type="number" name='rollNumber' placeholder='Enter roll number in digit' value={student.rollNumber} onChange={(e)=>handleChange?handleChange(e):""} /><br/>
        ...
        <input type="number" name='pincode' placeholder='Pin Code' value={student.pincode} onChange={(e)=>handleChange?handleChange(e):""} /> <br/>
